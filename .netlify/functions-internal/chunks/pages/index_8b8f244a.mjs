...
import 'html-escaper';
import { $ as $$MainLayout } from './about_dbe0941f.mjs';
import { B as Button, A as ArrowSec } from './contact_262ec0d7.mjs';
...
const Experience = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("h5", { className: "text-primary-100 text-[50px] lg:text-[85px] tracking-widest leading-[70px] font-dm lg:leading-[106.25px] ", children: num }),
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const services = [
    {
      title: "Formaci\xF3n en prevenci\xF3n",
      text: "There are many variations of the passages of lorem Ipsum from available, majority."
    },
    {
      title: "Dise\xF1amos e implementamos",
      text: "There are many variations of the passages of lorem Ipsum from available, majority."
    },
    {
      title: "Implementamos procesos de",
      text: "There are many variations of the passages of lorem Ipsum from available, majority."
    }
  ];
  const reviews = [
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Diligenciascortes.com - Home", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="w-full bg-hero bg-no-repeat bg-cover h-screen lg:min-h-[110vh] px-12 xl:px-0 flex items-center " data-astro-cid-j7pv25f6> <div class="lg:max-w-[1200px] w-full mx-auto flex flex-col" data-astro-cid-j7pv25f6> <h1 class="text-[40px] leading-[50px] md:text-[50px] xl:text-[65px] pb-4 font-dm md:leading-[60.25px] w-full xl:max-w-[50%] text-primary-200" data-astro-cid-j7pv25f6> Eleva tu empresa con un programa AML integral </h1> <p class="text-base md:text-[22px] pb-5 font-jost text-text-gray-200 w-full lg:max-w-[50%]" data-astro-cid-j7pv25f6>Somos tu aliado en la implementacion de procesos y controles para dar cumplimento a la normativa de Prevención del Lavado de Activos y Financiamiento del Terrrorismo.</p> ${renderComponent($$result2, "Button", Button, { "text": "Contactanos", "data-astro-cid-j7pv25f6": true })} </div> </section>  <section class="lg:max-w-[1200px] flex flex-col gap-8 lg:gap-10 lg:flex-row px-12 xl:px-0 w-full mx-auto pt-[100px] lg:pt-[200px] justify-between " data-astro-cid-j7pv25f6> ${services.map((service) => {
    ...
    return renderTemplate`${renderComponent($$result2, "Experience", Experience, { "text": exp.text, "num": exp.num, "i": i, "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/acerosillo/Desktop/dev/caros/src/components/experience.tsx", "client:component-export": "default", "data-astro-cid-j7pv25f6": true })}`;
  })} </div> </section> ` })} `;
}, "/Users/acerosillo/Desktop/dev/caros/src/pages/index.astro", void 0);

const $$file = "/Users/acerosillo/Desktop/dev/caros/src/pages/index.astro";
const $$url = "";
